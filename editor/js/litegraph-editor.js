...
function normalizeRendererProfile(profile) {
  ...
  return RENDERER_PROFILE_OPTIONS.some((item) => item.value === profile) ? profile : null;
}
function normalizeTheme(theme) {
  if (!theme) {
    return null;
  }
  return THEME_OPTIONS.some((item) => item.value === theme) ? theme : null;
}
function normalizeGraphTheme(theme) {
  if (!theme) {
    return null;
  }
  return GRAPH_THEME_OPTIONS.some((item) => item.value === theme) ? theme : null;
}
...
function getRendererProfile() {
  ...
  try {
    const stored = (_a = globalThis.localStorage) == null ? void 0 : _a.getItem(RENDERER_PROFILE_STORAGE_KEY);
...
function setRendererProfile(profile) {
  ...
  try {
    (_a = globalThis.localStorage) == null ? void 0 : _a.setItem(RENDERER_PROFILE_STORAGE_KEY, normalized);
  } catch (_error) {
  }
  return normalized;
}
function getEditorTheme() {
  ...
  try {
    const stored = (_a = globalThis.localStorage) == null ? void 0 : _a.getItem(THEME_STORAGE_KEY);
...
function setEditorTheme(theme) {
  ...
  try {
    (_a = globalThis.localStorage) == null ? void 0 : _a.setItem(THEME_STORAGE_KEY, normalized);
  } catch (_error) {
  }
  return normalized;
}
function getGraphTheme() {
  ...
  try {
    const stored = (_a = globalThis.localStorage) == null ? void 0 : _a.getItem(GRAPH_THEME_STORAGE_KEY);
...
function setGraphTheme(theme) {
  ...
  try {
    (_a = globalThis.localStorage) == null ? void 0 : _a.setItem(GRAPH_THEME_STORAGE_KEY, normalized);
  } catch (_error) {
  }
  return normalized;
}
...
function applyGraphThemeToCanvas(graphcanvas, theme) {
  ...
  if (preset.canvas) {
    graphcanvas.round_radius = (_a = preset.canvas.roundRadius) != null ? _a : graphcanvas.round_radius;
    graphcanvas.connections_width = (_b = preset.canvas.connectionsWidth) != null ? _b : graphcanvas.connections_width;
    graphcanvas.render_shadows = (_c = preset.canvas.renderShadows) != null ? _c : graphcanvas.render_shadows;
    graphcanvas.render_connections_shadows = (_d = preset.canvas.renderConnectionsShadows) != null ? _d : graphcanvas.render_connections_shadows;
    graphcanvas.title_text_font = (_e = preset.canvas.titleTextFont) != null ? _e : graphcanvas.title_text_font;
    graphcanvas.inner_text_font = (_f = preset.canvas.innerTextFont) != null ? _f : graphcanvas.inner_text_font;
  }
  (_g = graphcanvas.setDirty) == null ? void 0 : _g.call(graphcanvas, true, true);
}
...
function applyEditorTheme(theme = getEditorTheme()) {
  ...
  (_b = (_a = globalThis.document) == null ? void 0 : _a.documentElement) == null ? void 0 : _b.setAttribute("data-lg-theme", resolved);
  return resolved;
}
...
function createDefaultRendererAdapter() {
  var _a, _b;
  const LeaferAdapter = (_a = LiteGraph) == null ? void 0 : _a.LeaferUIRendererAdapter;
  const Canvas2DAdapter = (_b = LiteGraph) == null ? void 0 : _b.Canvas2DRendererAdapter;
...
function createGraphCanvas(canvas, graph) {
  ...
  const options = rendererAdapter ? {
    rendererAdapter,
    renderStyleProfile: useLeaferComponentsProfile ? "leafer-pragmatic-v1" : "legacy",
    renderStyleEngine: useLeaferComponentsProfile ? "leafer-components" : "legacy",
...
class Editor {
  ...
  addRendererSwitcher() {
    ...
    select.addEventListener("change", () => {
      ...
      (_b = (_a2 = globalThis.location) == null ? void 0 : _a2.reload) == null ? void 0 : _b.call(_a2);
    });
    wrapper.appendChild(select);
    (_a = this.root.querySelector(".header .tools-left")) == null ? void 0 : _a.appendChild(wrapper);
  }
  addThemeSwitcher() {
    var _a;
    const wrapper = document.createElement("label");
  ...
  onLoadButton() {
    ...
    fileInput.addEventListener("change", (event) => {
      var _a;
      var file = (_a = event.target.files) == null ? void 0 : _a[0];
      if (!file) {
        return;
      }
    ...
    loadButton.addEventListener("click", () => {
      var _a;
      const url = (_a = urlInput.value) == null ? void 0 : _a.trim();
      if (!url) {
        return;
      }
  ...
  addMiniWindow(w, h) {
    ...
    graphcanvas.onRenderBackground = function(canvas2, ctx) {
      ctx.strokeStyle = "#567";
  ...
  isFullscreen() {
    return document.fullscreenElement || document.mozRequestFullscreen || document.webkitRequestFullscreen || false;
  }
  exitFullscreen() {
