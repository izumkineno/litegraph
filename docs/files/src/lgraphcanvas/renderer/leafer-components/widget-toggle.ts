# 文件文档：`src/lgraphcanvas/renderer/leafer-components/widget-toggle.ts`
...
## 1. `renderWidgetToggle`

- 类型：`function`
- 位置：`src/lgraphcanvas/renderer/leafer-components/widget-toggle.ts:8-66` (`#L8`)
- 说明来源：源码注释
- 说明：
...
- 代码片段（L8-L27）：
```js
export function renderWidgetToggle(env) {
