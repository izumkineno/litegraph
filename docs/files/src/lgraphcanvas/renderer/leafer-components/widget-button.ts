# 文件文档：`src/lgraphcanvas/renderer/leafer-components/widget-button.ts`
...
## 1. `renderWidgetButton`

- 类型：`function`
- 位置：`src/lgraphcanvas/renderer/leafer-components/widget-button.ts:8-52` (`#L8`)
- 说明来源：源码注释
- 说明：
