# 文件文档：`src/litegraph/modules/math-color-utils.js`
...
## 1. `setMathColorUtilsMethodsLiteGraph`

- 类型：`function`
- 位置：`src/litegraph/modules/math-color-utils.js:3-5` (`#L3`)
- 说明来源：[AUTO] 自动回退
- 说明：
> [AUTO] 导出函数 `setMathColorUtilsMethodsLiteGraph`，定义于 `src/litegraph/modules/math-color-utils.js`。
...
## 2. `mathColorUtilsMethods`

- 类型：`variable`
- 位置：`src/litegraph/modules/math-color-utils.js:7-94` (`#L7`)
- 说明来源：[AUTO] 自动回退
- 说明：
> [AUTO] 导出变量 `mathColorUtilsMethods`（const），定义于 `src/litegraph/modules/math-color-utils.js`。
