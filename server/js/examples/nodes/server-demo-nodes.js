...
LiteGraph.registerNodeType("server_demo/counter", ServerDemoCounter);

class ServerDemoScale {
...
LiteGraph.registerNodeType("server_demo/scale", ServerDemoScale);
